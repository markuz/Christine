...
class library(gtk.Widget,libraryBase):
    ...
    def add_columns(self):
        ...
        tn.set_visible(self.gconf.get_value("ui/show_tn"))
        tn.set_visible(True)
        tv.append_column(tn)
        ...
        artist.set_visible(self.gconf.get_value("ui/show_artist"))
        ...
        album.set_visible(self.gconf.get_value("ui/show_album"))
        ...
        type.set_visible(self.gconf.get_value("ui/show_type"))
        ...
        play.set_visible(self.gconf.get_value("ui/show_play_count"))
        ...
        length.set_visible(self.gconf.get_value("ui/show_length"))
        ...
        genre.set_visible(self.gconf.get_value("ui/show_genre"))
